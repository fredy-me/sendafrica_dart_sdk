...
| 1. Package foundation | Replace the generated template metadata and exports; select and pin minimal Dart dependencies; add static analysis, formatting, test, and publish checks. | `dart analyze`, `dart format --output=none`, and tests run on a clean checkout. | Pending |
